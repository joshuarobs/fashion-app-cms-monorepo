...
import { HeuristicItemsTable } from './HeuristicItemsTable';
import { PopupItemFilters } from '../../items/PopupItemFilters/_PopupItemFilters';
import { FilterOutlined } from '@ant-design/icons';
import { Layout, Row, Col, Select, Input, Button, Tag } from 'antd';
// import {TagManager} from "../../items/PopupItemFilters/tagManager";
import { generateTabs } from '../../items/PopupItemFilters/tagManager';
...
import { CompanyDataManager } from '../../items/PopupItemFilters/companyDataManager';
...
function PrimaryFrame() {
  ...
  return (
    ...
    >
      ...
      >
        <HeuristicItemsTable show={settingShow} />
      </Row>
    </Content>
  );
}
