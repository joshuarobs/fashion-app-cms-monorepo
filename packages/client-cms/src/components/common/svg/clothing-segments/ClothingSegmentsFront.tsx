...
interface ClothingSegmentsFrontProps {
  isLeftSide?: boolean;
  clothingSegmentsData: ClothingSegmentsData;
  scaleFactor?: number;
}

function ClothingSegmentsFront({
  isLeftSide,
  clothingSegmentsData,
  scaleFactor = 1,
}: ClothingSegmentsFrontProps) {
  ...
  const ARM_3 = [
    ...
    />,
    <path
      d="M158.045 375C159.407 370.685 160.927 366.875 162.383 363.812C164.206 358.9 165.332 354.005 165.986 349.5L116.474 345C115.935 352.27 115.94 359.432 116.851 365.712C117.103 373.278 117.365 382.798 117.59 393.5L153.765 396.5C154.388 388.749 156.047 381.33 158.045 375Z"
      fill="#5D9EFF"
    />,
    <path
      d="M155.433 419C154.677 416.088 154.164 413.12 153.858 410.136C153.39 405.577 153.404 400.983 153.765 396.5L117.59 393.5C117.738 400.559 117.87 408.133 117.972 416L155.433 419Z"
      fill="#5D9EFF"
    />,
    <path
      d="M162.707 550.315C170.639 513.395 171.482 466.084 170.924 443.435C170.196 442.866 169.536 442.304 168.831 441.661C167.046 440.032 165.446 438.311 164.016 436.514C163.361 435.692 162.742 434.853 162.158 434C158.968 429.347 156.802 424.266 155.433 419L117.972 416C117.985 416.995 117.997 417.996 118.009 419C118.459 457.154 118.17 501.431 115.611 527.24C115.227 531.614 113.627 542.277 110.211 552L130.426 555.665L144.684 558.25L159.85 561C160.686 556.087 161.936 552.176 162.707 550.315Z"
      fill="#5D9EFF"
    />,
    <path
  ...
  const BODY_BACK = {
    path: (
      <path
        d="M272.217 799.531C275.567 794.208 278.428 787.808 280.275 780.269C277.026 779.944 272.697 778.912 268.147 776.735C268.318 776.931 268.498 777.2 268.683 777.55C269.023 778.194 269.382 779.116 269.74 780.388C270.456 782.934 271.168 786.878 271.718 792.79C271.796 793.634 271.872 794.518 271.943 795.443C272.042 796.724 272.134 798.086 272.217 799.531Z"
        fill="#5D9EFF"
      />
    ),
  };
  const PATH_UPPER_PELVIS = {
    path: (
      <path
        key={id_i++}
        d="M243.316 745H282.5L282.5 700.906H234.5C234.516 708.96 236.452 726.929 243.316 745Z"
        fill="#5D9EFF"
      />
    ),
  };
  ...
  const PATH_GROIN = {
    path: (
      <path
        key={id_i++}
        d="M249.531 758.595C254.228 767.565 260.917 773.074 267.283 776.309C267.572 776.455 267.86 776.597 268.147 776.735C272.697 778.912 277.026 779.944 280.275 780.269C281.089 780.351 281.835 780.388 282.5 780.388L282.5 758.595L282.5 745H243.316C245.055 749.578 247.11 754.163 249.531 758.595Z"
        fill="#5D9EFF"
      />
    ),
  };
  ...
  const ARM = [
    ...
    },
    {
      ...
      path: (
        <path
          key={id_i++}
          d="M162.383 363.812C160.927 366.875 159.407 370.685 158.045 375C156.047 381.33 154.388 388.749 153.765 396.5C153.404 400.983 153.39 405.577 153.858 410.136C154.164 413.12 154.677 416.088 155.433 419L117.972 416C117.87 408.133 117.738 400.559 117.59 393.5C117.365 382.798 117.103 373.278 116.851 365.712C115.94 359.432 115.935 352.27 116.474 345L165.986 349.5C165.332 354.005 164.206 358.9 162.383 363.812Z"
          fill="#5D9EFF"
        />
      ),
    },
  ...
  const BODY = [
    {
      ...
      path: (
        <path
          key={id_i++}
          d="M244.032 215H282.5L282.5 212C274.425 212 270.662 211.251 266.051 208.254C260.979 204.393 252.645 199.964 244.662 193.683C244.617 200.513 244.438 207.976 244.032 215Z"
          fill="#5D9EFF"
        />
      ),
    },
    ...
    },
    {
      ...
      path: (
        <path
          key={id_i++}
          d="M162.383 363.812C160.927 366.875 159.407 370.685 158.045 375H282.5L282.5 345H166.505C166.382 346.443 166.212 347.949 165.986 349.5C165.332 354.005 164.206 358.9 162.383 363.812Z"
          fill="#5D9EFF"
        />
      ),
    },
    {
      ...
      path: (
        <path
          key={id_i++}
          d="M282.5 375H158.045C156.047 381.33 154.388 388.749 153.765 396.5C153.404 400.983 153.39 405.577 153.858 410.136C154.164 413.12 154.677 416.088 155.433 419C156.802 424.266 158.968 429.347 162.158 434H282.5L282.5 375Z"
          fill="#5D9EFF"
        />
      ),
    },
    {
      ...
      path: (
        <path
          key={id_i++}
          d="M164.016 436.514C165.446 438.311 167.046 440.032 168.831 441.661C169.536 442.304 170.196 442.866 170.924 443.435C171.213 445.727 171.62 448.646 172.134 452H282.5L282.5 434H162.158C162.742 434.853 163.361 435.692 164.016 436.514Z"
          fill="#5D9EFF"
        />
      ),
    },
    ...
    },
    {
      ...
      path: [
        PATH_UPPER_PELVIS.path,
        <path
          key={id_i++}
          d="M146.82 700.906C146.397 704.752 144.791 714.752 141.747 723.982C140.765 726.962 139.19 734.218 137.679 745H243.316C236.452 726.929 234.516 708.96 234.5 700.906H146.82Z"
          fill="#5D9EFF"
        />,
      ],
    },
    {
      ...
      path: [
        ...
        <path
          key={id_i++}
          d="M267.283 776.309C260.917 773.074 254.228 767.565 249.531 758.595C247.11 754.163 245.055 749.578 243.316 745H137.679C136.372 754.322 135.112 766.28 134.324 780.388H269.738C269.381 779.117 269.022 778.194 268.683 777.55C268.498 777.2 268.318 776.931 268.147 776.735C267.86 776.597 267.572 776.455 267.283 776.309Z"
          fill="#5D9EFF"
        />,
      ],
    },
    {
      ...
      path: (
        <path
          key={id_i++}
          d="M133.502 809H272.568C272.528 806.664 272.459 804.382 272.355 802.182C272.312 801.268 272.266 800.385 272.217 799.531C272.134 798.086 272.042 796.724 271.943 795.443C271.872 794.518 271.796 793.634 271.718 792.79C271.615 791.681 271.506 790.642 271.392 789.668C270.9 785.45 270.32 782.458 269.738 780.388H134.324C133.988 786.392 133.738 792.786 133.606 799.531C133.546 802.615 133.51 805.772 133.502 809Z"
          fill="#5D9EFF"
        />
      ),
    },
    {
      ...
      path: (
        <path
          key={id_i++}
          d="M272.568 809H133.502C133.488 814.782 133.562 820.789 133.744 827C133.821 829.631 133.918 832.298 134.035 835H272.053C272.18 832.372 272.291 829.693 272.38 827C272.58 820.938 272.666 814.801 272.568 809Z"
          fill="#5D9EFF"
        />
      ),
    },
  ...
  // const allSvgs2 = [...ARM, ...BODY];

  const sleeveStart =
    !isLeftSide || (isLeftSide && clothingSegmentsData.sleeves_is_symmetrical)
  ...
  const bodyStart =
    !isLeftSide || (isLeftSide && clothingSegmentsData.body_is_symmetrical)
  ...
  const specialGroinFill = !isLeftSide
    ? clothingSegmentsData.right_special_groin_fill
    : clothingSegmentsData.left_special_groin_fill;
  ...
  const segmentsGroin = [];
  // console.log('specialGroinFill:', specialGroinFill);
  switch (specialGroinFill) {
    case 'FULL':
      segmentsGroin.push(PATH_GROIN);
      segmentsGroin.push(PATH_UPPER_PELVIS);
      break;
    case 'HALF':
      segmentsGroin.push(PATH_GROIN);
      break;
  ...
  const svgs = [...segmentsArm, ...segmentsBody, ...segmentsGroin];

  // console.log("segmentsGroin:", segmentsGroin);
  const effectiveBodyBackStart = bodyStartBack ? bodyStartBack : 0;
  const effectiveBodyBackEnd = bodyEndBack ? bodyEndBack : 0;
  if (
    effectiveBodyBackStart <= ClothingSegmentBounds.Body_190_Below_Groin &&
    effectiveBodyBackEnd >= ClothingSegmentBounds.Body_200_Upper_Thigh_55
  ) {
    svgs.push(BODY_BACK);
  }
