...
const resolvers = {
  ...
  Mutation: {
    ...
    insertItemGlobalMediaPromoteToReview: (_, { revision_id }, context) =>
      insertItemGlobalMediaPromoteToReview(revision_id, context),
    //--------------------------------------------------
    ...
    updateItemGlobalMaindataRevisionStatePromoteToProduction: (
      ...
      { id },
      context
    ) => updateItemGlobalMaindataRevisionStatePromoteToProduction(id, context),
    //--------------------------------------------------
    // item_maindata
    //--------------------------------------------------
    //--------------------------------------------------
